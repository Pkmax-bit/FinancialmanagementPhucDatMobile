...
import { ArrowLeft, Save, Users, FolderKanban, Calendar, Plus, Trash2 } from 'lucide-react';

export default function QuoteFormMockup() {
  return (
      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow mb-4">
          ...
          <div className="space-y-3">
            ...
            {/* Valid Until */}
            <div>
              <label className="text-xs text-slate-500 mb-2 block">Hiệu lực đến *</label>
        ...
        <div className="bg-white rounded-xl p-4 shadow mb-4">
          <div className="flex items-center justify-between mb-3">
            <span className="text-slate-900">Dịch vụ / Sản phẩm</span>
        ...
        {/* Terms */}
        <div className="bg-white rounded-xl p-4 shadow mb-4">
          <div className="text-slate-900 mb-3">Điều khoản</div>
          <textarea
